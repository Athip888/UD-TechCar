...
<body>
  ...
  <aside class="sidebar">
    ...
    <ul>
      ...
      <li><a href="admin_status.php"><img src="../image/car-front-fill.svg" alt="">งานรออนุมัติ</a></li>
      <li><a href="adduser.php"><img src="../image/person-fill-add.svg" alt="">เพิ่มผู้ใช้งาน</a></li>
      <li><a href="cardetails.php"><img src="../image/plus-circle-fill.svg" alt="">เพิ่มข้อมูลรถยนต์</a></li>
      <li><a href="car888.php"><img src="../image/plus-circle-fill.svg" alt="">รายละเอียดรถยนต์</a></li>
      <li><a href="admin_userfmt.php"><img src="../image/check-circle-fill.svg" alt="">ข้อมูลผู้ใช้งาน</a></li>
      <li><a href="Driver.php"><img src="../image/person-vcard-fill.svg" alt="">ข้อมูลพนักงานขับรถ</a></li>
