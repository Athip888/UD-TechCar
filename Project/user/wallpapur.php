...
<header class="header">
    ...
    <div class="profile-login d-flex align-items-center">
                ...
                <div class="user-info">
                    <img src="../image/462556874_418535704648446_3167043835905327483_n.jpg" alt="Profile Picture" class="profile-pic">
                    <span class="username" id="username">อธิป หำใหญ่</span>
                </div>
            </div>
  ...
  <aside class="sidebar">
    ...
    <ul>
      ...
      <li><a href="login.php"><img src="../image/door-open-fill.svg" alt="">ออกจากระบบ</a></li>
    </ul>
  </aside>
  <script>
