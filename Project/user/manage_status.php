...
<body>
    ...
    $sql = "SELECT * FROM requests ORDER BY request_date DESC LIMIT 1";
                ...
                <table class="table table-bordered table-custom">
                    ...
                    <tbody>
                        <tr class="clickable-row">
                            <td>
                                <div style="width: 100%; height: 80px; background-color: #f8f9fa;"></div>
                            </td> <!-- Adjusted height -->
                            ...
                            mysqli_close($connect); // ใช้ตัวแปร `$conn` แทน `$connect`
                            ?>
