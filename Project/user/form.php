      ...
      <div class="container mt-5">
        <div class="row">
          ...
          <div class="col-12 col-sm-12 col-md-6 col-lg-6 mt-2">
            ...
            <input type="date" name="departure_date" id="departure_date" class="form-control"placeholder="วัน/เดือน/ปี" require>
          </div>
          ...
          <div class="col-12 col-sm-12 col-md-6 col-lg-6 mt-2">
            ...
            <input type="date" name="return_date" id="return_date" class="form-control"placeholder="วัน/เดือน/ปี" require>
          </div>
          ...
          <div class="d-flex justify-content-center mt-4  h-30">
    <button type="submit" class="btn btn-success d-flex align-items-center">
        <img src="../image/floppy-fill.svg" alt="" class="me-1"> บันทึก
    </button>
</div>
