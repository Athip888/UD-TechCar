    ...
    <form action="" method="POST" >
      <div class="container mt-5">
        <div class="row">
          ...
          <input type="text" id="fullname" class="form-control" placeholder="ชื่อสกุล">
          </div>
          ...
          <input type="number" name="passenger_count" id="passenger_count" class="form-control" placeholder="มีคนนั่ง">
          </div>
